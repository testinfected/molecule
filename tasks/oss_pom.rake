module Enhancements
  class Pom
    ...
    def add_mit_license
      self.licenses["MIT License"] = "http://opensource.org/licenses/MIT"
    end
...
module Buildr
  class Project #:nodoc:
    def pom
      unless @pom
        @pom = parent ? parent.pom.dup : Enhancements::Pom.new
      ...
      class << package
        def pom
          unless @pom || classifier
            ...
            @pom.content Enhancements::Pom.pom_xml(buildr_project, self)
          end
          @pom
        end
      end
